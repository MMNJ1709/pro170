    ...
    init:async function(){
      ...
      mainPlane.appendChild(titlePlane);
       ...
       toyTitle.setAttribute("text",{
        font:"aileronsemibold",color:"#290149",width:4.5,height:3,align:"left",value:toy.toy_name.toUpperCase()
       })
       titlePlane.appendChild(toyTitle);
        ...
        description.setAttribute("text",{
         font:"dejavu",color:"#6b011f",width:2,height:5,align:"left",letterSpacing:2,lineHeight:50,value:`${toy.description}`
        })
        ...
        age.setAttribute("text",{
         font:"aileronsemibold",color:"#290149",width:2,height:5,align:"center",value:`AGE: ${toy.age_group}`
        })
